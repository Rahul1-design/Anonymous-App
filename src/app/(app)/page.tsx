...
const Home = () => {
  return (
    <>
      <main className=' flex-col flex items-center justify-center px-4 md:px-24 py-12  '>
        <section className='text-center mb-8 md:mb-12'>
          <h1 className='text-3xl md:text-5xl font-bold'>Dive into the World of Anonymous Conversation</h1>
          <p className='mt-3 font-semibold md:mt-4 text-base md:text-lg'>Expore Mystery Message - Where your identity remains a secret.</p>
        </section>
